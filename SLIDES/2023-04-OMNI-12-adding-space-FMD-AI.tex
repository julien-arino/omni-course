...
\maxFrameImage{../FIGS/Keeling_etal-vaccination-FMD-model-inverted}
...
\maxFrameImage{../FIGS/Cabezas_etal-FMD-US-feedlots-otherprime-inverted}
...
%%%%%%%%%%%%%%%%%%%
\maxFrameImage{../FIGS/Bradhurst_etal-FMD-Australia-cover}
\maxFrameImage{../FIGS/Bradhurst_etal-FMD-Australia-model-in-patches.jpg}
\maxFrameImage{../FIGS/Bradhurst_etal-FMD-Australia-model-between-patches.jpg}
\maxFrameImage{../FIGS/Bradhurst_etal-FMD-Australia-wind-dissemination.jpg}
\maxFrameImage{../FIGS/Bradhurst_etal-FMD-Australia-farm-types}
 
%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%
\subsection{Buhnerkempe \emph{et al}}
%%%%%%%%%%%%%%%%%%%
\maxFrameImage{../FIGS/Buhnerkempe_etal-US-cattle-movement-cover} 
\maxFrameImage{../FIGS/Buhnerkempe_etal-US-cattle-movement-transmission-routes}
\maxFrameImage{../FIGS/Buhnerkempe_etal-US-cattle-movement-parameters}
\maxFrameImage{../FIGS/Buhnerkempe_etal-US-cattle-movement-cattle-movement}
\maxFrameImage{../FIGS/Buhnerkempe_etal-US-cattle-movement-connected-component}
\maxFrameImage{../FIGS/Buhnerkempe_etal-US-cattle-movement-outdegree}
\maxFrameImage{../FIGS/Buhnerkempe_etal-US-cattle-movement-indegree}
\maxFrameImage{../FIGS/Buhnerkempe_etal-US-cattle-movement-epidemic-extent-infection-risk}
\maxFrameImage{../FIGS/Buhnerkempe_etal-US-cattle-movement-movement-vs-local}

%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%
\subsection{Glass \& Barnes}
%%%%%%%%%%%%%%%%%%%
\maxFrameImage{../FIGS/GlassBarnes-metapopulation-infection-control-cover}
\maxFrameImage{../FIGS/GlassBarnes-metapopulation-infection-control-interventions}
\maxFrameImage{../FIGS/GlassBarnes-metapopulation-infection-control-scenarios1}
\maxFrameImage{../FIGS/GlassBarnes-metapopulation-infection-control-scenarios2}
...
%%%%%%%%%%%%%%%%%%%
\maxFrameImage{../FIGS/Nickbakhsh_etal-metapop-AI-cover}
\maxFrameImage{../FIGS/Nickbakhsh_etal-metapop-AI-betweenness}
\maxFrameImage{../FIGS/Nickbakhsh_etal-metapop-AI-metapop}
\maxFrameImage{../FIGS/Nickbakhsh_etal-metapop-AI-baseline-model}
\maxFrameImage{../FIGS/Nickbakhsh_etal-metapop-AI-force-infection-on-premises1}
\maxFrameImage{../FIGS/Nickbakhsh_etal-metapop-AI-force-infection-on-premises2}
\maxFrameImage{../FIGS/Nickbakhsh_etal-metapop-AI-control-measures}
\maxFrameImage{../FIGS/Nickbakhsh_etal-metapop-AI-relative-risk-infection} 
\maxFrameImage{../FIGS/Nickbakhsh_etal-metapop-AI-tradeoffs}

%%%%%%%%%%%%%%%%%%%
\maxFrameImage{../FIGS/Fournie_etal-H5N1-rest-days-cover}
\maxFrameImage{../FIGS/Fournie_etal-H5N1-rest-days-model-within}
\maxFrameImage{../FIGS/Fournie_etal-H5N1-rest-days-model-between}
\maxFrameImage{../FIGS/Fournie_etal-H5N1-rest-days-strategy-timing}
\maxFrameImage{../FIGS/Fournie_etal-H5N1-rest-days-strategy-spatial}
\maxFrameImage{../FIGS/Fournie_etal-H5N1-rest-days-FoI1}
\maxFrameImage{../FIGS/Fournie_etal-H5N1-rest-days-FoI2}
\maxFrameImage{../FIGS/Fournie_etal-H5N1-rest-days-FoI3}
\maxFrameImage{../FIGS/Fournie_etal-H5N1-rest-days-sims}

%%%%%%%%%%%%%%%%%%%
\maxFrameImage{../FIGS/Lee_etal-AI-Korea-cover}
\maxFrameImage{../FIGS/Lee_etal-AI-Korea-farm-densities}
\maxFrameImage{../FIGS/Lee_etal-AI-Korea-model1}
\maxFrameImage{../FIGS/Lee_etal-AI-Korea-model2}
\maxFrameImage{../FIGS/Lee_etal-AI-Korea-R0-compute}
\maxFrameImage{../FIGS/Lee_etal-AI-Korea-R0-sim}
\maxFrameImage{../FIGS/Lee_etal-AI-Korea-intervention1}
\maxFrameImage{../FIGS/Lee_etal-AI-Korea-intervention2}

%%%%%%%%%%%%%%%%%%%
\maxFrameImage{../FIGS/Bourouiba_etal-AI-spread-cover}
\maxFrameImage{../FIGS/Bourouiba_etal-AI-spread-periods}
\maxFrameImage{../FIGS/Bourouiba_etal-AI-spread-migration}
\maxFrameImage{../FIGS/Bourouiba_etal-AI-spread-timing-of-events}
\maxFrameImage{../FIGS/Bourouiba_etal-AI-spread-model1}
