...
\begin{frame}{Control mechanisms}
	Consider two mechanisms of control
	\begin{itemize}
		\item Compartmentalisation: allow spatial and within-company links
		\item Zoning: allow within-population network-mediated links (beyond 10 km) and between-population network links
	\end{itemize}
\end{frame}
