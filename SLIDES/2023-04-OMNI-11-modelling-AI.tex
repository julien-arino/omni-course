...
%\maxFrameImage{../FIGS/AI-cases-humans-inverted}
\maxFrameImageBottomTitle{../FIGS/Kalthoff_etal-HPAI-human-cases-inverted}{Kalthoff \emph{et al}/Veterinary Microbiology (2010)}
%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%
\subsection{Tiensen \emph{et al} on H5N1 in Thailand}
...
%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%
\subsection{Nickbakhsh \emph{et al} on co-circulating LPAI strains}
